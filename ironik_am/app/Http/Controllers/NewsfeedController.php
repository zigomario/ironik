...
class NewsfeedController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $postsnewsfeed=Users_posts::WhereHas('users.user_followed', function ($q) use($id) {

            $q->where('user_follow.users_id_1', $id)->whereNull('user_follow.deleted_at');
